        ...
        try:
            ...
            for eq_id in equipment_ids:
                ...
                if cursor.fetchone()[0] == 0:
                    messagebox.showwarning("Предупреждение", f"Оборудование с ID {eq_id} не найдено в базе данных.")
                    continue
            ...
            if updated_count > 0:
                ...
                messagebox.showwarning("Предупреждение", "Не удалось обновить ни одну единицу техники. Возможно, ID нет базе данных.")
